...
//        layoutParams.behavior = BottombarBehavior()
    ...
    inner class ArticleBinding : Binding() {
        ...
        private var content: String by ObserveProp(getString(R.string.loading)) {
        ...
        override fun onFinishInflate() {
            dependsOn<Boolean, Boolean, List<Pair<Int, Int>>, Int>(
                ...
                ::searchResults,
                ::searchPosition
            ) { isLC, isS, sResults, sPosition ->
                if (!isLC && isS) {
                    renderSearchResult(sResults)
                    renderSearchPosition(sPosition)
                }
                if (!isLC && !isS) {
                    clearSearchResult()
                }
                bottombar.bindSearchInfo(sResults.size, sPosition)
            }
        }
        ...
        override fun restoreUi(savedState: Bundle) {
            savedState.getBoolean(::isFocusedSearch.name)
        }
    }
}